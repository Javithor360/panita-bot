  ...
  const embed = new EmbedBuilder()
    ...
    .addFields(
      ...
      },
      {
        ...
        value: 'Si necesitas ayuda con la instalación, por favor abre un ticket en [este canal](https://discord.com/channels/707103390852710491/1406385534712156301/1521266058206511146).'
      }
    )
